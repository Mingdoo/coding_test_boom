...
# print('expected : 56')
print(solution('BAB'))
# print('JABAA', solution('JABAA'))
# print('JANNA', solution('JANNA'))
# print('CANAAAAANAN', solution('BABAAAAABAB'))
# print('AABAAAAAAABBB', solution('AABAAAAAAABBB'))
# print("ABAAAAABAB",solution("ABAAAAABAB"))